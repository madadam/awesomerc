...
apptags =
{
    ["Gran Paradiso"] = { screen = 1, tag = 1}, -- This is firefox actually...
...
globalkeys =
{
    ...
    -- Layout manipulation
    key({ modkey, "Control" }, "Left", function () awful.client.swap.byidx(  1) end),
    key({ modkey, "Control" }, "Right", function () awful.client.swap.byidx( -1) end),
